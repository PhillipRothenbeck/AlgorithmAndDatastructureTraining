...
uint32_t my_hash(const string &key) {
    ...
    // find a specific and unambiguous number for the key
    ...
    switch (hash) {
        case 803624592:  // John Smith
            return 0;
        case 803612634:  // Lisa Smith
            return 1;
        case 112823953:  // Sam Doe
            return 2;
        case 153802357:  // Sandra Dee
            return 3;
        default:
            return UINT32_MAX;
    }
